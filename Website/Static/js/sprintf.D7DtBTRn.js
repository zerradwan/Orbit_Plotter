...
function m() {
    ...
    function(k) {
        (function() {
            ...
            function v(t, o) {
                ...
                for (a = 0; a < c; a++)
                    if (typeof t[a] == "string")
                        ...
                        r.keys)
                            for (e = o[n],
                            s = 0; s < r.keys.length; s++) {
                                if (e == null)
                                    throw new Error(f('[sprintf] Cannot access property "%s" of undefined value "%s"', r.keys[s], r.keys[s - 1]));
                                e = e[r.keys[s]]
                            }
                        else
                            r.param_no ? e = o[r.param_no] : e = o[n++];
                        if (i.not_type.test(r.type) && i.not_primitive.test(r.type) && e instanceof Function && (e = e()),
                        i.numeric_arg.test(r.type) && typeof e != "number" && isNaN(e))
                            throw new TypeError(f("[sprintf] expecting number but found %T", e));
                        switch (i.number.test(r.type) && (y = e >= 0),
                        r.type) {
                        case "b":
                        ...
                        case "s":
                            e = String(e),
                            e = r.precision ? e.substring(0, r.precision) : e;
                            break;
                        case "t":
                            e = String(!!e),
                            e = r.precision ? e.substring(0, r.precision) : e;
                        ...
                        i.json.test(r.type) ? p += e : (i.number.test(r.type) && (!y || r.sign) ? (u = y ? "+" : "-",
                        e = e.toString().replace(i.sign, "")) : u = "",
                        d = r.pad_char ? r.pad_char === "0" ? "0" : r.pad_char.charAt(1) : " ",
                        h = r.width - (u + e).length,
                        l = r.width && h > 0 ? d.repeat(h) : "",
                        p += r.align ? u + e + l : d === "0" ? u + l + e : l + u + e)
                    }
                return p
            }
            ...
            k.sprintf = f,
            k.vsprintf = w,
            typeof window < "u" && (window.sprintf = f,
            window.vsprintf = w)
        }
        )()
    }(b)),
