import {a_ as Ve, bM as h, a$ as p, a5 as Rt, bN as qt, p as Qt, X as Bt, aj as jt, r as We, au as Xt} from "./index.CD8HuT3N.js";
import {b as Gt, d as M, e as T, f as D} from "./possibleConstructorReturn.DgiPnZ9N.js";
import {_ as O} from "./createSuper.B6W-Dh9S.js";
function C(o) {
    if (o === null || o === !0 || o === !1)
        return NaN;
    var a = Number(o);
...
function qe(o, a) {
    ...
    var r = f(o)
      , t = C(a);
    return isNaN(t) ? new Date(NaN) : (t && r.setDate(r.getDate() + t),
    r)
}
function _e(o, a) {
    d(2, arguments);
...
function Oe(o, a) {
    ...
    var i = n.getDate();
    return e >= i ? n : (r.setFullYear(n.getFullYear(), n.getMonth(), e),
    r)
}
function st(o, a) {
    d(2, arguments);
...
function Be(o) {
    ...
    var a = f(o)
      , r = a.getMonth();
    return a.setFullYear(a.getFullYear(), r + 1, 0),
...
function Mt(o, a) {
    ...
    if (n < 1)
        ...
        r.setMonth(r.getMonth() - e * n);
        var u = he(r, t) === -e;
        nr(f(o)) && n === 1 && he(o, t) === 1 && (u = !1),
        i = e * (n - Number(u))
    }
    return i === 0 ? 0 : i
}
...
function Pe(o) {
    ...
    return a.setUTCFullYear(o.getFullYear()),
    o.getTime() - a.getTime()
}
function ie(o) {
    d(1, arguments);
...
function Ie(o, a) {
    ...
    d(1, arguments);
    var c = J()
      , v = C((r = (t = (e = (n = a?.weekStartsOn) !== null && n !== void 0 ? n : a == null || (i = a.locale) === null || i === void 0 || (u = i.options) === null || u === void 0 ? void 0 : u.weekStartsOn) !== null && e !== void 0 ? e : c.weekStartsOn) !== null && t !== void 0 ? t : (s = c.locale) === null || s === void 0 || (l = s.options) === null || l === void 0 ? void 0 : l.weekStartsOn) !== null && r !== void 0 ? r : 0);
    if (!(v >= 0 && v <= 6))
        throw new RangeError("weekStartsOn must be between 0 and 6 inclusively");
    var g = f(o)
      , w = g.getDay()
      , y = (w < v ? -7 : 0) + 6 - (w - v);
    return g.setDate(g.getDate() + y),
...
function Ae(o) {
    ...
    var a = f(o)
      , r = a.getFullYear();
    return a.setFullYear(r + 1, 0, 0),
    a.setHours(23, 59, 59, 999),
    a
}
function pr(o) {
    return d(1, arguments),
    o instanceof Date || Ve(o) === "object" && Object.prototype.toString.call(o) === "[object Date]"
}
function Pt(o) {
    if (d(1, arguments),
    !pr(o) && typeof o != "number")
        return !1;
    var a = f(o);
...
function oe(o) {
    ...
    var a = 1
      ...
      , t = r.getUTCDay()
      , e = (t < a ? 7 : 0) + t - a;
    return r.setUTCDate(r.getUTCDate() - e),
...
function re(o, a) {
    ...
    var g = f(o)
      , w = g.getUTCDay()
      , y = (w < v ? 7 : 0) + w - v;
    return g.setUTCDate(g.getUTCDate() - y),
...
function Ze(o, a) {
    ...
    var c = f(o)
      , v = c.getUTCFullYear()
      , g = J()
      , w = C((r = (t = (e = (n = a?.firstWeekContainsDate) !== null && n !== void 0 ? n : a == null || (i = a.locale) === null || i === void 0 || (u = i.options) === null || u === void 0 ? void 0 : u.firstWeekContainsDate) !== null && e !== void 0 ? e : g.firstWeekContainsDate) !== null && t !== void 0 ? t : (s = g.locale) === null || s === void 0 || (l = s.options) === null || l === void 0 ? void 0 : l.firstWeekContainsDate) !== null && r !== void 0 ? r : 1);
    if (!(w >= 1 && w <= 7))
        throw new RangeError("firstWeekContainsDate must be between 1 and 7 inclusively");
    var y = new Date(0);
    y.setUTCFullYear(v + 1, 0, w),
    y.setUTCHours(0, 0, 0, 0);
    var E = re(y, a)
      , _ = new Date(0);
    _.setUTCFullYear(v, 0, w),
...
function Tr(o, a) {
    ...
    d(1, arguments);
    var c = J()
      , v = C((r = (t = (e = (n = a?.firstWeekContainsDate) !== null && n !== void 0 ? n : a == null || (i = a.locale) === null || i === void 0 || (u = i.options) === null || u === void 0 ? void 0 : u.firstWeekContainsDate) !== null && e !== void 0 ? e : c.firstWeekContainsDate) !== null && t !== void 0 ? t : (s = c.locale) === null || s === void 0 || (l = s.options) === null || l === void 0 ? void 0 : l.firstWeekContainsDate) !== null && r !== void 0 ? r : 1)
      , g = Ze(o, a)
      , w = new Date(0);
    w.setUTCFullYear(g, 0, v),
...
function _t(o, a) {
    d(1, arguments);
    var r = f(o)
      , t = re(r, a).getTime() - Tr(r, a).getTime();
...
var Z = {
    ...
    S: function(a, r) {
        var t = r.length
          ...
          , n = Math.floor(e * Math.pow(10, t - 3));
        return b(n, r.length)
    }
}
  , ae = {
  ...
  , Mr = {
    ...
    b: function(a, r, t) {
        ...
        switch (e === 12 ? n = ae.noon : e === 0 ? n = ae.midnight : n = e / 12 >= 1 ? "pm" : "am",
        r) {
        case "b":
        case "bb":
            return t.dayPeriod(n, {
    ...
    B: function(a, r, t) {
        var e = a.getUTCHours(), n;
        switch (e >= 17 ? n = ae.evening : e >= 12 ? n = ae.afternoon : e >= 4 ? n = ae.morning : n = ae.night,
        r) {
        case "B":
        case "BB":
        case "BBB":
...
var xr = {
  ...
  , kr = function(a, r, t) {
    var e, n = xr[a];
    return typeof n == "string" ? e = n : r === 1 ? e = n.one : e = n.other.replace("{{count}}", r.toString()),
    t != null && t.addSuffix ? t.comparison && t.comparison > 0 ? "in " + e : e + " ago" : e
};
function $e(o) {
    return function() {
        var a = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}
          , r = a.width ? String(a.width) : o.defaultWidth
          , t = o.formats[r] || o.formats[o.defaultWidth];
        return t
    }
}
var _r = {
...
function de(o) {
    return function(a, r) {
        ...
        if (t === "formatting" && o.formattingValues) {
            var n = o.defaultFormattingWidth || o.defaultWidth
              , i = r != null && r.width ? String(r.width) : n;
            e = o.formattingValues[i] || o.formattingValues[n]
        } else {
            var u = o.defaultWidth
              , s = r != null && r.width ? String(r.width) : o.defaultWidth;
...
function fe(o) {
    return function(a) {
        var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}
          , t = r.width
          , e = t && o.matchPatterns[t] || o.matchPatterns[o.defaultMatchWidth]
          , n = a.match(e);
        if (!n)
            return null;
        ...
        l = o.valueCallback ? o.valueCallback(s) : s,
...
function Br(o) {
    return function(a) {
        var r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}
          , t = a.match(o.matchPattern);
        if (!t)
            return null;
        var e = t[0]
          , n = a.match(o.parsePattern);
        if (!n)
            return null;
...
function ca(o, a, r) {
    ...
    var K = String(a)
      , I = J()
      , F = (t = (e = r?.locale) !== null && e !== void 0 ? e : I.locale) !== null && t !== void 0 ? t : Je
      , G = C((n = (i = (u = (s = r?.firstWeekContainsDate) !== null && s !== void 0 ? s : r == null || (l = r.locale) === null || l === void 0 || (c = l.options) === null || c === void 0 ? void 0 : c.firstWeekContainsDate) !== null && u !== void 0 ? u : I.firstWeekContainsDate) !== null && i !== void 0 ? i : (v = I.locale) === null || v === void 0 || (g = v.options) === null || g === void 0 ? void 0 : g.firstWeekContainsDate) !== null && n !== void 0 ? n : 1);
    if (!(G >= 1 && G <= 7))
        throw new RangeError("firstWeekContainsDate must be between 1 and 7 inclusively");
    ...
    var ue = Pe(V)
      ...
      , Ue = K.match(oa).map(function(W) {
        ...
        var ee = Mr[$];
        if (ee)
            return !(r != null && r.useAdditionalWeekYearTokens) && Nt(W) && Ce(W, a, String(o)),
            !(r != null && r.useAdditionalDayOfYearTokens) && Et(W) && Ce(W, a, String(o)),
            ee(se, W, F.localize, le);
        if ($.match(la))
...
var Pa = 10
    ...
    return D(r, [{
        ...
        value: function(e, n) {
            if (n.timestampIsSet)
                return e;
            var i = new Date(0);
            return i.setFullYear(e.getUTCFullYear(), e.getUTCMonth(), e.getUTCDate()),
            i.setHours(e.getUTCHours(), e.getUTCMinutes(), e.getUTCSeconds(), e.getUTCMilliseconds()),
            i
        }
    }]),
    r
  ...
  , ka = function(o) {
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 140),
        h(p(t), "incompatibleTokens", ["R", "u", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
...
var _a = function(o) {
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 130),
        h(p(t), "incompatibleTokens", ["Y", "R", "u", "w", "I", "i", "e", "c", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
        ...
        value: function(e, n, i) {
            ...
            if (i.isTwoDigitYear) {
                var s = Wt(i.year, u);
                return e.setUTCFullYear(s, 0, 1),
                e.setUTCHours(0, 0, 0, 0),
                e
            }
            var l = !("era"in n) || n.era === 1 ? i.year : 1 - i.year;
            return e.setUTCFullYear(l, 0, 1),
            e.setUTCHours(0, 0, 0, 0),
            e
        }
    }]),
  ...
  , Ya = function(o) {
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 130),
        h(p(t), "incompatibleTokens", ["y", "R", "u", "Q", "q", "M", "L", "I", "d", "D", "i", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
        ...
        value: function(e, n, i, u) {
            ...
            if (i.isTwoDigitYear) {
                var l = Wt(i.year, s);
                return e.setUTCFullYear(l, 0, u.firstWeekContainsDate),
                e.setUTCHours(0, 0, 0, 0),
                re(e, u)
            }
            var c = !("era"in n) || n.era === 1 ? i.year : 1 - i.year;
            return e.setUTCFullYear(c, 0, u.firstWeekContainsDate),
            e.setUTCHours(0, 0, 0, 0),
            re(e, u)
        }
    }]),
  ...
  , Ea = function(o) {
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 130),
        h(p(t), "incompatibleTokens", ["G", "y", "Y", "u", "Q", "q", "M", "L", "w", "d", "D", "e", "c", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
  ...
  , Na = function(o) {
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 130),
        h(p(t), "incompatibleTokens", ["G", "y", "Y", "R", "w", "I", "i", "e", "c", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
  ...
  , Ua = function(o) {
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 120),
        h(p(t), "incompatibleTokens", ["Y", "R", "q", "M", "L", "w", "I", "d", "D", "i", "e", "c", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
  ...
  , Ha = function(o) {
    ...
    function r() {
        ...
        for (var e = arguments.length, n = new Array(e), i = 0; i < e; i++)
            n[i] = arguments[i];
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "incompatibleTokens", ["Y", "R", "q", "Q", "L", "w", "I", "D", "i", "e", "c", "t", "T"]),
        h(p(t), "priority", 110),
        t
    }
    return D(r, [{
  ...
  , Wa = function(o) {
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 110),
        h(p(t), "incompatibleTokens", ["Y", "R", "q", "Q", "M", "w", "I", "D", "i", "e", "c", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
...
function Ia(o, a, r) {
    ...
    var t = f(o)
      , e = C(a)
      , n = _t(t, r) - e;
    return t.setUTCDate(t.getUTCDate() - n * 7),
    t
}
var Aa = function(o) {
    M(r, o);
...
function $a(o, a) {
    ...
    var r = f(o)
      , t = C(a)
      , e = kt(r) - t;
    return r.setUTCDate(r.getUTCDate() - e * 7),
    r
}
var La = function(o) {
    M(r, o);
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 100),
        h(p(t), "incompatibleTokens", ["y", "Y", "u", "q", "Q", "M", "L", "w", "d", "D", "e", "c", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
  ...
  , Fa = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31]
  , Ra = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31]
  , qa = function(o) {
    M(r, o);
    var a = O(r);
    function r() {
        ...
        h(p(t), "priority", 90),
        h(p(t), "subPriority", 1),
        h(p(t), "incompatibleTokens", ["Y", "R", "q", "Q", "w", "I", "D", "i", "e", "c", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
  ...
  , Qa = function(o) {
    ...
    function r() {
        ...
        h(p(t), "priority", 90),
        h(p(t), "subpriority", 1),
        h(p(t), "incompatibleTokens", ["Y", "R", "q", "Q", "M", "L", "w", "I", "d", "E", "i", "e", "c", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
...
function et(o, a, r) {
    ...
    d(2, arguments);
    var v = J()
      , g = C((t = (e = (n = (i = r?.weekStartsOn) !== null && i !== void 0 ? i : r == null || (u = r.locale) === null || u === void 0 || (s = u.options) === null || s === void 0 ? void 0 : s.weekStartsOn) !== null && n !== void 0 ? n : v.weekStartsOn) !== null && e !== void 0 ? e : (l = v.locale) === null || l === void 0 || (c = l.options) === null || c === void 0 ? void 0 : c.weekStartsOn) !== null && t !== void 0 ? t : 0);
    if (!(g >= 0 && g <= 6))
        throw new RangeError("weekStartsOn must be between 0 and 6 inclusively");
    var w = f(o)
      , y = C(a)
      ...
      , S = (_ + 7) % 7
      , A = (S < g ? 7 : 0) + y - E;
    return w.setUTCDate(w.getUTCDate() + A),
    w
}
var Ba = function(o) {
    M(r, o);
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 90),
        h(p(t), "incompatibleTokens", ["D", "i", "e", "c", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
  ...
  , ja = function(o) {
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 90),
        h(p(t), "incompatibleTokens", ["y", "R", "u", "q", "Q", "M", "L", "I", "d", "D", "E", "i", "c", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
  ...
  , Xa = function(o) {
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 90),
        h(p(t), "incompatibleTokens", ["y", "R", "u", "q", "Q", "M", "L", "I", "d", "D", "E", "i", "e", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
...
function Ga(o, a) {
    ...
    var t = 1
      ...
      , u = (i + 7) % 7
      , s = (u < t ? 7 : 0) + r - n;
    return e.setUTCDate(e.getUTCDate() + s),
    e
}
var za = function(o) {
    M(r, o);
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 90),
        h(p(t), "incompatibleTokens", ["y", "Y", "u", "q", "Q", "M", "L", "w", "d", "D", "E", "e", "c", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
  ...
  , Va = function(o) {
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 80),
        h(p(t), "incompatibleTokens", ["b", "B", "H", "k", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
        ...
        key: "set",
        value: function(e, n, i) {
            return e.setUTCHours(Ke(i), 0, 0, 0),
            e
        }
    }]),
    r
  ...
  , Za = function(o) {
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 80),
        h(p(t), "incompatibleTokens", ["a", "B", "H", "k", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
  ...
  , Ja = function(o) {
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 80),
        h(p(t), "incompatibleTokens", ["a", "b", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
  ...
  , Ka = function(o) {
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 70),
        h(p(t), "incompatibleTokens", ["H", "K", "k", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
        ...
        value: function(e, n, i) {
            ...
            return u && i < 12 ? e.setUTCHours(i + 12, 0, 0, 0) : !u && i === 12 ? e.setUTCHours(0, 0, 0, 0) : e.setUTCHours(i, 0, 0, 0),
            e
        }
    }]),
    r
  ...
  , en = function(o) {
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 70),
        h(p(t), "incompatibleTokens", ["a", "b", "h", "K", "k", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
  ...
  , tn = function(o) {
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 70),
        h(p(t), "incompatibleTokens", ["h", "H", "k", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
        ...
        value: function(e, n, i) {
            var u = e.getUTCHours() >= 12;
            return u && i < 12 ? e.setUTCHours(i + 12, 0, 0, 0) : e.setUTCHours(i, 0, 0, 0),
            e
        }
    }]),
    r
  ...
  , rn = function(o) {
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 70),
        h(p(t), "incompatibleTokens", ["a", "b", "h", "H", "K", "t", "T"]),
        t
    }
    return D(r, [{
        key: "parse",
  ...
  , un = function(o) {
    ...
    function r() {
        ...
        return t = a.call.apply(a, [this].concat(n)),
        h(p(t), "priority", 10),
        h(p(t), "incompatibleTokens", ["t", "T", "x"]),
        t
    }
    return D(r, [{
        key: "parse",
        value: function(e, n) {
            switch (n) {
            case "X":
                return X(j.basicOptionalMinutes, e);
            case "XX":
                return X(j.basic, e);
            case "XXXX":
                return X(j.basicOptionalSeconds, e);
            case "XXXXX":
                return X(j.extendedOptionalSeconds, e);
            case "XXX":
            default:
                return X(j.extended, e)
            }
        }
    }, {
        key: "set",
  ...
  , fn = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g
  , vn = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g
  , hn = /^'([^]*?)'?$/
  , mn = /''/g
  , pn = /\S/
...
function wn(o, a, r, t) {
    ...
    var I = String(o)
      , F = String(a)
      , G = J()
      , z = (e = (n = t?.locale) !== null && n !== void 0 ? n : G.locale) !== null && e !== void 0 ? e : Je;
    if (!z.match)
        throw new RangeError("locale must contain match property");
    var V = C((i = (u = (s = (l = t?.firstWeekContainsDate) !== null && l !== void 0 ? l : t == null || (c = t.locale) === null || c === void 0 || (v = c.options) === null || v === void 0 ? void 0 : v.firstWeekContainsDate) !== null && s !== void 0 ? s : G.firstWeekContainsDate) !== null && u !== void 0 ? u : (g = G.locale) === null || g === void 0 || (w = g.options) === null || w === void 0 ? void 0 : w.firstWeekContainsDate) !== null && i !== void 0 ? i : 1);
    if (!(V >= 1 && V <= 7))
        throw new RangeError("firstWeekContainsDate must be between 1 and 7 inclusively");
    var ue = C((y = (E = (_ = (S = t?.weekStartsOn) !== null && S !== void 0 ? S : t == null || (A = t.locale) === null || A === void 0 || (B = A.options) === null || B === void 0 ? void 0 : B.weekStartsOn) !== null && _ !== void 0 ? _ : G.weekStartsOn) !== null && E !== void 0 ? E : (L = G.locale) === null || L === void 0 || (K = L.options) === null || K === void 0 ? void 0 : K.weekStartsOn) !== null && y !== void 0 ? y : 0);
    if (!(ue >= 0 && ue <= 6))
        throw new RangeError("weekStartsOn must be between 0 and 6 inclusively");
    if (F === "")
        return I === "" ? f(r) : new Date(NaN);
    var se = {
    ...
    try {
        var Lt = function() {
            var x = ee.value;
            !(t != null && t.useAdditionalWeekYearTokens) && Nt(x) && Ce(x, F, o),
            !(t != null && t.useAdditionalDayOfYearTokens) && Et(x) && Ce(x, F, o);
            var R = x[0]
              , we = dn[R];
            if (we) {
...
function Mn(o, a) {
    ...
    var r = f(o)
      ...
      , n = r.getDate()
      , i = new Date(0);
    i.setFullYear(e, t, 15),
    i.setHours(0, 0, 0, 0);
    var u = Ut(i);
    return r.setMonth(t, Math.min(n, u)),
    r
}
function On(o, a) {
    d(2, arguments);
...
function Pn(o, a) {
    ...
    var r = f(o)
      , t = C(a);
    return isNaN(r.getTime()) ? new Date(NaN) : (r.setFullYear(t),
    r)
}
function be(o) {
    d(1, arguments);
...
function Te(o) {
    ...
    var a = f(o)
      , r = new Date(0);
    return r.setFullYear(a.getFullYear(), 0, 1),
    r.setHours(0, 0, 0, 0),
    r
}
function Cn(o, a) {
    ...
    if (e.timezone) {
        ...
        var c = new Date(u + s)
          , v = new Date(0);
        return v.setFullYear(c.getUTCFullYear(), c.getUTCMonth(), c.getUTCDate()),
        v.setHours(c.getUTCHours(), c.getUTCMinutes(), c.getUTCSeconds(), c.getUTCMilliseconds()),
        v
    }
...
function Yn(o) {
    ...
    if (r.length > 2)
        return a;
    if (/:/.test(r[0]) ? t = r[0] : (a.date = r[0],
    t = r[1],
    De.timeZoneDelimiter.test(a.date) && (a.date = o.split(De.timeZoneDelimiter)[0],
    t = o.substr(a.date.length, o.length))),
    t) {
        var e = De.timezone.exec(t);
        e ? (a.time = t.replace(e[1], ""),
        a.timezone = e[1]) : a.time = t
    }
    return a
}
function En(o, a) {
...
function Nn(o, a) {
    ...
    var t = !!r[4]
      ...
      , s = ve(r[5]) - 1;
    if (t)
        return $n(a, u, s) ? Hn(a, u, s) : new Date(NaN);
    var l = new Date(0);
    return !In(a, n, i) || !An(a, e) ? new Date(NaN) : (l.setUTCFullYear(a, n, Math.max(e, i)),
    l)
}
function ve(o) {
...
function Rn(o, a) {
    ...
    if (isNaN(e.getTime()))
        throw new RangeError("Invalid time value");
    var n = String((r = a?.format) !== null && r !== void 0 ? r : "extended")
      , i = String((t = a?.representation) !== null && t !== void 0 ? t : "complete");
    ...
    if (i !== "date") {
        ...
        if (y !== 0) {
            var E = Math.abs(y)
              , _ = b(Math.floor(E / 60), 2)
              , S = b(E % 60, 2)
              , A = y < 0 ? "+" : "-";
            s = "".concat(A).concat(_, ":").concat(S)
        } else
            s = "Z";
        var B = b(e.getHours(), 2)
          , L = b(e.getMinutes(), 2)
          , K = b(e.getSeconds(), 2)
          , I = u === "" ? "" : "T"
          , F = [B, L, K].join(c);
...
class Gn {
    constructor({locale: a, formats: r}={}) {
        ...
        ,
        this.addSeconds = (t, e) => zt(t, e),
        this.addMinutes = (t, e) => Zt(t, e),
        this.addHours = (t, e) => Kt(t, e),
        this.addDays = (t, e) => qe(t, e),
        this.addWeeks = (t, e) => er(t, e),
        this.addMonths = (t, e) => Oe(t, e),
        this.addYears = (t, e) => st(t, e),
        this.isValid = t => Pt(this.date(t)),
        this.getDiff = (t, e, n) => {
            var i;
        ...
        ,
        this.isAfter = (t, e) => ye(t, e),
        this.isBefore = (t, e) => ne(t, e),
        this.startOfDay = t => ie(t),
        this.endOfDay = t => Qe(t),
        this.getHours = t => ha(t),
        this.setHours = (t, e) => Tn(t, e),
        this.setMinutes = (t, e) => Dn(t, e),
        this.getSeconds = t => ga(t),
        this.setSeconds = (t, e) => On(t, e),
        this.isSameDay = (t, e) => ba(t, e),
        this.isSameMonth = (t, e) => Da(t, e),
        this.isSameYear = (t, e) => Ta(t, e),
        this.isSameHour = (t, e) => Ma(t, e),
        this.startOfYear = t => Te(t),
        this.endOfYear = t => Ae(t),
        this.startOfMonth = t => be(t),
        this.endOfMonth = t => Be(t),
        this.startOfWeek = t => Le(t, {
            locale: this.locale
        }),
        this.endOfWeek = t => Ie(t, {
            locale: this.locale
        }),
        this.getYear = t => wa(t),
        this.setYear = (t, e) => Pn(t, e),
        this.date = t => typeof t > "u" ? new Date : t === null ? null : new Date(t),
        this.toJsDate = t => t,
        this.parse = (t, e) => t === "" ? null : wn(t, e, new Date, {
            locale: this.locale
        }),
        this.format = (t, e) => this.formatByString(t, this.formats[e]),
        this.formatByString = (t, e) => ca(t, e, {
            locale: this.locale
        }),
        this.isEqual = (t, e) => t === null && e === null ? !0 : ya(t, e),
        this.isNull = t => t === null,
        this.isAfterDay = (t, e) => ye(t, Qe(e)),
        this.isBeforeDay = (t, e) => ne(t, ie(e)),
        this.isBeforeYear = (t, e) => ne(t, Te(e)),
        this.isAfterYear = (t, e) => ye(t, Ae(e)),
        this.isWithinRange = (t, [e,n]) => qn(t, {
            start: e,
            end: n
        }),
        this.formatNumber = t => t,
        this.getMinutes = t => ma(t),
        this.getDate = t => fa(t),
        this.setDate = (t, e) => bn(t, e),
        this.getMonth = t => pa(t),
        this.getDaysInMonth = t => Ut(t),
        this.setMonth = (t, e) => Mn(t, e),
        this.getMeridiemText = t => t === "am" ? "AM" : "PM",
        this.getNextMonth = t => Oe(t, 1),
        this.getPreviousMonth = t => Oe(t, -1),
        ...
        ,
        this.locale = a,
        this.formats = Object.assign({}, Xn, r)
    }
    isBeforeMonth(a, r) {
        return ne(a, be(r))
    }
...
function Kn(o, a) {
    ...
    if (r != null) {
        var t = [], e = !0, n = !1, i, u;
        try {
            for (r = r.call(o); !(e = (i = r.next()).done) && (t.push(i.value),
            !(a && t.length === a)); e = !0)
                ;
        } catch (s) {
            n = !0,
...
var $t = 60
  ...
  , bt = ti(function o(a) {
    var r = this;
    ri(this, o),
    m(this, "adapter", void 0),
    m(this, "cloneAdapter", function(t, e) {
        var n = {
            MomentUtils: {
                formats: {
                    monthNumber: "M",
    ...
    m(this, "dateToSeconds", function(t) {
        var e = r.adapter.getSeconds(t)
          , n = r.adapter.getMinutes(t) * $t
          , i = r.adapter.getHours(t) * ai;
        return e + n + i
    }),
    ...
    m(this, "differenceInCalendarMonths", function(t, e) {
        var n = r.adapter.getYear(t) - r.adapter.getYear(e)
          , i = r.adapter.getMonth(t) - r.adapter.getMonth(e);
        return n * 12 + i
    }),
    ...
    m(this, "setDate", function(t, e) {
        var n = r.adapter.startOfMonth(t)
          , i = r.adapter.mergeDateAndTime(n, t)
          , u = r.adapter.setSeconds(i, r.adapter.getSeconds(t));
    ...
    m(this, "applyDateToTime", function(t, e) {
        if (!t)
            return e;
        var n = r.adapter.getYear(e)
          , i = r.adapter.getMonth(e)
          , u = r.getDate(e)
          , s = r.adapter.setYear(t, n)
          , l = r.adapter.setMonth(s, i);
    ...
    m(this, "set", function(t, e) {
        var n = t;
        return e.year != null && (n = r.setYear(n, e.year)),
        e.month != null && (n = r.setMonth(n, e.month)),
        e.date != null && (n = r.setDate(n, Number(e.date))),
        e.hours != null && (n = r.setHours(n, Number(e.hours))),
        e.minutes != null && (n = r.setMinutes(n, Number(e.minutes))),
        e.seconds != null && (n = r.setSeconds(n, Number(e.seconds))),
        n
    }),
...
function Ge() {
    return Ge = Object.assign ? Object.assign.bind() : function(o) {
        for (var a = 1; a < arguments.length; a++) {
            var r = arguments[a];
            for (var t in r)
...
function vi(o, a) {
    if (a && (Xe(a) === "object" || typeof a == "function"))
        return a;
    if (a !== void 0)
  ...
  , wi = function(o) {
    ...
    function r(t) {
        ...
        Q(q(e), "secondsToLabel", function(n, i) {
            var u = e.dateHelpers.secondsToHourMinute(n)
              , s = Re(u, 2)
              , l = s[0]
              , c = s[1]
              , v = function(y) {
            ...
            if (i === "12") {
                ...
                return g && (l -= 12),
                l === 0 && (l = 12),
                "".concat(l, ":").concat(v(c), " ").concat(g ? "PM" : "AM")
            }
            return "".concat(v(l), ":").concat(v(c))
        }),
        Q(q(e), "stringToOptions", function(n) {
            var i = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "12"
              , u = /^(1[0-2]|0?[1-9]):([0-5][0-9]) ?([AaPp][Mm]?)?$/
        ...
        Q(q(e), "handleChange", function(n) {
            var i = e.dateHelpers.secondsToHourMinute(n)
              , u = Re(i, 2)
              , s = u[0]
              , l = u[1]
              , c = e.setTime(e.props.value, s, l, 0);
        ...
        Q(q(e), "setTime", function(n, i, u, s) {
            var l = e.dateHelpers
              ...
              , v = l.setMinutes
              , g = l.setHours
              , w = e.props.adapter.startOfDay(e.props.adapter.date(n || void 0));
        ...
        Q(q(e), "getTimeWindowInSeconds", function(n) {
            var i = e.props
              , u = i.minTime
              , s = i.maxTime
              , l = i.ignoreMinMaxDateComponent
              , c = e.setTime(e.props.value, 0, 0, 0)
              , v = e.setTime(e.props.value, 24, 0, 0);
            !u || e.props.adapter.isBefore(u, c) && !l ? u = c : u = e.setTime(e.props.value, e.props.adapter.getHours(u), e.props.adapter.getMinutes(u), e.props.adapter.getSeconds(u)),
            !s || e.props.adapter.isAfter(s, v) && !l ? s = v : s = e.setTime(e.props.value, e.props.adapter.getHours(s), e.props.adapter.getMinutes(s), e.props.adapter.getSeconds(s) + 1);
            var g = e.props.adapter.toJsDate(u)
              , w = e.props.adapter.toJsDate(s)
              , y = e.props.adapter.toJsDate(c);
            return {
                start: (g - y) / 1e3,
                end: (w - y) / 1e3
            }
        ...
        Q(q(e), "buildSelectedOption", function(n) {
            var i = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "12"
              , u = e.dateHelpers.dateToSeconds(n);
            return {
                id: u,
                label: e.secondsToLabel(u, i || "12")
            }
        }),
        e.dateHelpers = new bt(t.adapter),
        e
    }
    return ci(r, [{
        ...
        value: function() {
            ...
            if (this.props.value && this.props.adapter.isValid(this.props.value))
                ...
                var n = this.dateHelpers.dateToSeconds(this.props.adapter.date())
                  , i = Dt;
        ...
        value: function(e) {
            var n = e.format !== this.props.format
              , i = e.step !== this.props.step
              , u = e.adapter !== this.props.adapter
              , s = e.minTime !== this.props.minTime
              , l = e.maxTime !== this.props.maxTime;
            if (u && (this.dateHelpers = new bt(this.props.adapter)),
            n || i || s || l) {
...
export {bt as D, wi as T, zn as a};
