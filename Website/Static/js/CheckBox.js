import {ad as $, ae as ie, af as v, r as u, ag as p} from "./index.CD8HuT3N.js";
var T = Object.freeze({
    default: "default",
    toggle: "toggle",
    toggle_round: "toggle"
...
function ae(e) {
    ...
    return r.direction === "rtl" && n === "Left" ? n = "Right" : r.direction === "rtl" && n === "Right" && (n = "Left"),
    q({}, "padding".concat(n), a)
}
function le(e) {
    var t = e.$disabled
      , o = e.$checked
...
var E = $("span", function(e) {
    var t = e.$checked
      ...
      , l = a.sizing
      , c = a.animation
      , s = o ? a.colors.tickMarkFillDisabled : r ? a.colors.tickMarkFillError : a.colors.tickMarkFill
  ...
  `))
      , h = a.borders.checkboxBorderRadius
      , b = ne(e);
    return {
        flex: "0 0 auto",
    ...
    return de(o, [{
        ...
        value: function() {
            var i = this.props
              ...
              , l = i.onChange
              , c = i.labelPlacement
              , s = c === void 0 ? this.props.checkmarkType === T.toggle ? "left" : "right" : c
              , w = i.inputRef
              , y = i.isIndeterminate
              , h = i.error
              , b = i.disabled
              ...
              , V = O && u.createElement(G, g({
                $labelPlacement: s
            }, m, p(j)), this.props.containsInteractiveElement ? u.createElement("div", {
                onClick: function(oe) {
                    return oe.preventDefault()
                }
            }, O) : O);
            return u.createElement(K, g({
                "data-baseweb": "checkbox",
                title: Z || null,
                $labelPlacement: s
            }, m, re, p(D)), (s === "top" || s === "left") && V, this.props.checkmarkType === T.toggle ? u.createElement(ee, g({}, m, p(N)), u.createElement(Q, g({}, m, p(A)))) : u.createElement(X, g({}, m, p(z))), u.createElement(J, g({
                value: I,
                name: W,
                checked: F,
                required: R,
